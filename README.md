...
- [New Training Model](.documentation/TRAINING.md)
...
## New Training ModelNew Training Data

For more information about creating new training data see this [link](./.documentation/TRAINING.md).
