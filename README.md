...
```bash
# build and start containers.  by default rasa serves at localhost:5005 (rasa) && serve at  and at localhost:8000 (duckling)
$ docker-compose up -d
```
...
| Location | About |
| :------- | ----- |
| `docker-compose.yml` | Bla |
| `README.md` | The document you are currently reading |
| `.documentation/` | Bla |
| `rasa-app-data/` | Bla |
| `rasa-app-data/model` | Bla |
| `training/` | Bla |
| `training/data/` | Bla |
| `training/model/` | Bla |
